...
# 创建全局锁
# pyvista_lock = threading.Lock()

# def process_question(item):
#     """Process question with PyVista lock protection."""
#     scene_id = item['scene_id']
#     question = item['question']
#     question_id = item['question_id']
#     gt = item['answers']
...
#         with pyvista_lock:
#             from lc_demo import agent
#             answer, turns, url, ai_eval = agent(
#                 scene_id=scene_id, 
#                 question_id=question_id, 
#                 question=question, 
#                 gts=gt
...
def main(num_processes=4, use_threads=False):
    ...
    output_qid_url_file = os.path.join(output_dir, "urls.log")
